...
const dummyProducts = [
  // Bearbrick Products (8 items)
  {
    ...
    gallery: [ //show ให้ user เห็นบนหน้า ProductDetails.jsx แบบ swipe เลื่อนได้ใน mobile
  ...
  },
 {
  ...
  // Popmart Products (8 items)
  {
    ...
    description: "A collectible toy featuring Labubu, a cute monster character designed by Molly.", //show ให้ user เห็นบนหน้า ProductDetails.jsx
    price: "6999", // format ให้เป็น "฿ x,xxx" ทำตอน render ใน frontend
    condition: "New", // tag มุมขวาบน มี 3 แบบ (New / New-Unboxed / Displayed, Like New)
